...
public class MainFrame extends JFrame implements ActionListener {
	...
	protected void btnEmployeeActionPerformed(ActionEvent e) {
		...
		/*
		 * JFrame frame = new JFrame(); frame.setBounds(100, 100, 450, 400);
		 * EmployeeUIService service = new EmployeeUIService(); List<Department> list =
		 * service.showDeptList(); EmployeePanel tp = new EmployeePanel();
		 * tp.setCmbDeptList(list); tp.getCmbDept().addItemListener(new ItemListener() {
		 * 
		 ...
		 * }); tp.setCmbTitleList(service.showTitleList()); frame.add(tp);
		 * frame.setVisible(true);
		 */
	}
}
